...
class DashboardController extends Controller
{
    public function clientsList(){
        ...
        $clientsPrepago = AccountPrepagoBags::rightJoin('companies', 'account_prepago_bags.company_id', '=', 'companies.id')
                    ...
                    ->select('account_prepago_bags.id','account_prepago_bags.company_id' ,'companies.settings' ,'account_prepago_bags.production', 'account_prepago_bags.is_postpago', 'account_prepago_bags.enabled', 'account_prepago_bags.phase')
