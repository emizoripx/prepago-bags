                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($client->phase == 'Testing')
                                                <a class="dropdown-item" data-type="actions-dashboard"
                                                    data-href="{{ URL::to('dashboard/form-phase-piloto/' . $client->company_id) }}"
                                                    data-container=".action-modal">Pasar a pruebas piloto</a>
                                                <a class="dropdown-item" data-type="actions-dashboard"
                                                    data-href="{{ URL::to('dashboard/form-phase-production/' . $client->company_id) }}"
                                                    data-container=".action-modal">Pasar a producción</a>
                                            ...
                                            @if ($client->is_postpago)
                                                ...
                                                @else
                                                    <a class="dropdown-item disabled" data-type="data-action"
                                                        data-onclick="enablePostpago( $client->company_id )">Habilitar</a>
                                                @endif
                                            @endif
                                            <a class="dropdown-item" data-type="actions-dashboard"
