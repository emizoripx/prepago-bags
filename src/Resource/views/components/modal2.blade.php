...
<div class="modal-dialog modal-dialog-centered modal-lg bg-primary">
            ...
            <div class="modal-body">
                <div class="container">
                     ...
                     <div class="form-check">
                         <input class="form-check-input" type="radio" name="account_type" id="exampleRadios1" value="0"
                             checked>
                                     ...
                                     <tr>
                                         ...
                                         <td class="form-group">
                                             <input class="form-control" type="number"
                                                 id="postpago_limit[{{ $ds->fel_doc_sector_id }}]"
                                                 name="postpago_limit[{{ $ds->fel_doc_sector_id }}]">
                                         </td>
                                     </tr>
                                 @endforeach
                             </tbody>
